...
public final class IOC {
    ...
    private func setupViewModels() {
        ...
        container.autoregister(ContentDetailViewModel.self, argument: ContentDetailViewModel.Argument.self, initializer: ContentDetailViewModel.init)
        ...
        container.autoregister(OperationViewModel.self, argument: OperatorNode.self, initializer: OperationViewModel.init)
    }
